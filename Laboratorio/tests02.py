...
# Chusmeo el error
print('trans_afin(np.array([1,1]), 0,[2,3],[0,0])= ',trans_afin(np.array([1,1]), 0,[2,3],[0,0]), '\nDeberia ser: ', np.array([2,3]))
print('trans_afin(np.array([1,0]), np.pi/2,[3,2],[4,5])= ',  trans_afin(np.array([1,0]), np.pi/2,[3,2],[4,5]), '\nDeberia ser: ', np.array([4,7]))
assert(np.allclose(
